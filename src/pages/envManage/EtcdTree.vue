...
export default {
  ...
  methods: {
    ...
    confirmAdd () {
      ...
      this.$service.addKeyOnTree(this.addData).then(() => {
    ...
    getKeyTreeByEnv () {
      ...
      this.$service.getKeyTreeByEnv({ env: this.selectedEnv }).then(res => {
    ...
    nodeClick (value) {
      ...
      this.$service.getSettingByEnvAndKey({
        env: this.selectedEnv,
        keyName: this.currentKey.completePath,
      }).then(res => {
