...
<script>
import PopoverInTree from './caseManage/caseLibrary/components/PopoverInTree'
import TreeTable from './caseManage/caseLibrary/components/TreeTableNew'
import Drawer from './caseManage/caseLibrary/components/Drawer'
  ...
  data () {
    return {
      ...
      defaultProps: { // 用例树配置
        children: 'children',
        label: function (data) {
          return data.name + ' · ' + data.caseCount
        }
      },
      caseTreeData: [{ // 用例树数据
        id: '0',
